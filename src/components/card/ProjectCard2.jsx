      ...
      <div className='freelancer-style1 bdrs12 bdr1 hover-box-shadow'>
        <div className='d-flex align-items-center'>
          <div className='thumb w60 position-relative rounded-circle mr15'>
            <Image height={60} width={60} className='rounded-circle mx-auto' src={data.img} alt='rounded-circle' />
        ...
        <div className='details mt-4'>
          ...
          <h4>
            <small className='text fz14 me-3'>Hourly Rate</small> ${data.price.min} - ${data.price.max}
          </h4>
          <div className='d-grid mt15'>
            <Link href={`/project-single/${data.id}`} className='ud-btn btn-thm-border bdrs12 default-box-shadow1'>
              שלח הצעה
              <span>
                {" "}
