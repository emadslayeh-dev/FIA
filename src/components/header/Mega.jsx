...
export default function Mega({ staticMenuClass, textColor }) {
  return (
    <>
      <div id='mega-menu'>
        <a className={`btn-mega fw500 ${staticMenuClass ? staticMenuClass : ""} `} style={{ color: textColor }}>
          <span
            className={`pl10 pl10-xl pr5 fz15 vam flaticon-menu ${staticMenuClass ? staticMenuClass : ""} `}
