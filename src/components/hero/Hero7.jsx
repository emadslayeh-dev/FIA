...
const partners = [
  "/images/partners/Artboard 11_2x.png",
...
const heros = ["/images/about/HERO_IMAGE_1.jpg", "/images/about/HERO_IMAGE_2.jpg", "/images/about/HERO_IMAGE_3.jpg"];
            ...
            <div className='col-lg-7 col-xl-6'>
              ...
              <div className='pr50 pr0-md mb30-md position-relative'>
                <h1 className='animate-up-1 mb25'>
                  הדרך הקלה והמהירה למצוא ספקים <br className='d-none d-lg-block' />
                  ושירותים לתעשייה שלך.
                </h1>
                <p className='animate-up-2 ff-heading mb30'>
                  FIA מרכזת עבורך חומרי גלם, שירותים ופתרונות מותאמים לתעשיית המזון, הפארמה והביוטכנולוגיה.
                </p>
                  ...
                  <div className='row'>
                    ...
                    <div className='col-md-3 col-lg-4 col-xl-3'>
                      <div className='text-center'>
                        <button onClick={searchHandler} className='ud-btn btn-dark bdrs4 w-100' type='button'>
                          חיפוש
                        </button>
                      </div>
                    </div>
                ...
                <div className='home3-hero-partner mt40 animate-up-4'>
                  {partners.map((item, index) => (
                    <li key={index} className='d-inline-block me-3 me-sm-5 mb-3 mb-md-0'>
                      <Image height={26} width={84} src={item} className='h-100 w-100 object-fit-contain' alt='image' />
                    </li>
                  ))}
                </div>
                <Image
