          ...
          <div className='row mb30'>
            <div className='col-lg-12'>
              <div className='float-end'>
                <a onClick={printHandler} className='ud-btn btn-thm invoice_down_print'>
                  Print this invoice
                  ...
                  <div className='row mt55'>
                    <div className='col-sm-6 col-lg-7'>
                      <div className='invoice_date mb60'>
                        <div className='title mb5 ff-heading dark-color'>Invoice date:</div>
                    ...
                    <div className='col-sm-6 col-lg-5'>
                      <div className='invoice_date mb60'>
                        <div className='title mb5 ff-heading dark-color'>Due date:</div>
                        <h6 className='fw500 mb0'>03/10/2022</h6>
                      </div>
                      <div className='invoice_address'>
