          ...
          <div className='row align-items-center wow fadeInUp'>
            <div className='col-lg-9'>
              <div className='main-title mb30-lg'>
                <h2 className='title'>השירותים החמים של FIA</h2>
                <p className='paragraph'>מה שהכי מעניין את המשתמשים שלנו עכשיו</p>
              </div>
            </div>
          ...
          <div className='row'>
            {product1.slice(0, 8).map((item, i) => (
              <div key={i} className='col-sm-6 col-xl-3'>
                {item.gallery ? (
                  <PopularServiceSlideCard1 data={item} isContentExpanded={true} />
                ) : (
