...
export default function CompanyReviewForm({ companyId, onSubmitted }) {
  const [me, setMe] = useState(null);
  const [rating, setRating] = useState(5);
  const [comment, setComment] = useState("");
  const [submitting, setSubmitting] = useState(false);
  const canReview = me && companyId; // allow all authenticated users for now
  ...
  return (
    <div className='bsp_reveiw_wrt mb20' dir='rtl'>
      <h6 className='fz17'>הוסף ביקורת לחברה</h6>
        ...
        <form onSubmit={handleSubmit} className='comments_form mt30 mb30-md'>
          ...
          <div className='mb15'>
            ...
            <textarea
              ...
              placeholder='כתוב כאן את דעתך על החברה'
              required
            />
          </div>
